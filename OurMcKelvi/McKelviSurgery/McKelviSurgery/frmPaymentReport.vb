Public Class frmPaymentReport
    ...
    Private Sub frmPaymentReport_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub frmPaymentReport_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TblPaymentDataGridView_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles TblPaymentDataGridView.CellContentClick
        If e.ColumnIndex = 8 Then
            Dim obj As New frmViewPaymentReport
            obj.Tag = TblPaymentDataGridView.Rows(e.RowIndex).Cells(0).Value
            obj.ShowDialog()
        End If
    End Sub
